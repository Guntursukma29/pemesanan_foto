                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        @if ($pemesanans->isEmpty())
                            <p>Anda belum melakukan pemesanan promo apapun.</p>
                        @else
                                    ...
                                    @foreach ($pemesanans as $key => $pemesanan)
                                        <tr>
                                            ...
                                            <td>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                @else
                                                                    ...
                                                                    <form
                                                                        action="{{ route('pemesanans.promo.kode_foto', $pemesanan->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        <div class="mb-3">
                                                                            <label for="code_foto"
                                                                        ...
                                                                        <button type="submit"
                                                                            class="btn btn-primary">Simpan Kode
                                                                            Foto</button>
                                                                    </form>
                                                                @endif
                                                            </div>
                                                ...
                                                <div class="modal fade" id="detailModal-{{ $pemesanan->id }}"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p><strong>Nama Promo:</strong>
                                                                    {{ $pemesanan->promo->nama }}</p>
                                                                <p><strong>Harga:</strong>
                                                                    Rp{{ number_format($pemesanan->promo->harga, 0, ',', '.') }}
                                                                </p>
                                                ...
                                                @if ($pemesanan->status_pembayaran === 'belum bayar')
                                                    <!-- Button Bayar -->
                                                    <a href="{{ route('pemesanans.promo.bayar', $pemesanan->id) }}"
                                                        class="btn btn-success btn-sm"><i class="bi bi-currency-dollar"></i>
                                                        Bayar</a>
                                                    <!-- Button Ubah Jadwal -->
                                                    <button type="button" class="btn btn-warning btn-sm"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#ubahJadwalModalPromo-{{ $pemesanan->id }}">
                                                        Ubah Jadwal
                                                    </button>
                                                    <!-- Modal Ubah Jadwal -->
                                                    <div class="modal fade" id="ubahJadwalModalPromo-{{ $pemesanan->id }}"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="{{ route('pemesanans.promo.ubahJadwal', $pemesanan->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <div class="modal-body">
                                                    ...
                                                    <!-- Button Hapus -->
                                                    <form action="{{ route('pemesanans.promo.destroy', $pemesanan->id) }}"
                                                ...
                                                @else
                                                    ...
                                                    <!-- Modal Ulasan -->
                                                    <div class="modal fade" id="ulasModal-{{ $pemesanan->id }}"
                                                        tabindex="-1" aria-labelledby="ulasModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="ulasModalLabel">Berikan
                                                                        Ulasan untuk
                                                                        Pemesanan</h5>
                                                                    <button type="button" class="btn-close"
