            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <h4>Riwayat Pemesanan videografi</h4>
                        @if (session('success'))
                                ...
                                <tbody>
                                    @foreach ($pemesanans as $key => $pemesanan)
                                        <tr>
                                            ...
                                            <td>Rp{{ number_format($pemesanan->paket_jenis === 'special' ? $pemesanan->paket->harga_special : $pemesanan->paket->harga_platinum, 0, ',', '.') }}
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                @if ($pemesanan->status_pembayaran === 'belum bayar')
                                                    <!-- Button Ubah Jadwal -->
                                                    <a href="{{ route('pemesananvideografi.bayar', $pemesanan->id) }}"
                                                    ...
                                                    <!-- Button Hapus -->
                                                    <form
                                                        action="{{ route('pemesanans.videografi.destroy', $pemesanan->id) }}"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            @else
                                                                ...
                                                                <form
                                                                    action="{{ route('pemesanans.videografi.kode_foto', $pemesanan->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <div class="mb-3">
