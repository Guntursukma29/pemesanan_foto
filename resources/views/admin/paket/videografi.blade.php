...
@section('content')
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table " id="userTable">
                            ...
                            <tbody>
                                @foreach ($videografis as $index => $item)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $item->nama }}</td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form id="deleteForm{{ $item->id }}"
                                                action="{{ route('videografi.destroy', $item->id) }}" method="POST"
                                                style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                    ...
                                    <div class="modal fade" id="updateModal{{ $item->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('videografi.update', $item->id) }}" method="POST"
    ...
    <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createModalLabel">Tambah Data Videografi</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('videografi.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
