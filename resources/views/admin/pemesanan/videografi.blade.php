...
@section('content')
    <div class="container mt-4">
        <form method="GET" action="{{ route('admin.pemesanan.videografi.index') }}">
            <div class="row mb-3">
                <div class="col-md-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="table" id="userTable">
                            ...
                            <tbody>
                                @foreach ($pemesanans as $index => $pemesanan)
                                    <tr>
                                        ...
                                        <td> <!-- Tombol untuk membuka modal detail -->
                                            ...
                                            @if ($pemesanan->status_pemesanan !== 'selesai')
                                                @if ($pemesanan->fotografer)
                                                    ...
                                                    <form method="POST"
                                                        action="{{ route('reminder.videografi', $pemesanan->id) }}"
                                                        class="d-inline">
                                                        @csrf
                                    ...
                                    <div class="modal fade" id="inputFotograferModal{{ $pemesanan->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <form method="POST" action="{{ route('videografi.assign', $pemesanan->id) }}">
                                                @csrf
                                                <div class="modal-content">
                                                    <div class="modal-header">
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="9">Total Pemesanan Harga Spesial</td>
                                    <td colspan="2">Rp {{ number_format($totalHargaSpesial, 0, ',', '.') }}</td>
                                </tr>
                                <tr>
                                    <td colspan="9">Total Pemesanan Harga Platinum</td>
